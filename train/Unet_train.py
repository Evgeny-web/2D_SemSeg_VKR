...
path_loss_metrics = '../models/loss_metrics/U-Net'

segmodel = UNetModel(input_channels=3,
                     output_classes=20).to(device)

optimizer = get_unet_optimizer(segmodel)
...
for epoch in range(epochs):
    ...
    if epoch % 50 == 0:
        name = f"../models/checkpoints/Unet/{epoch}-from-{epochs}.pth"
