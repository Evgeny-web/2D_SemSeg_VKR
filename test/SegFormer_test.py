...
from models.created_classes.SegFormer.SegFormer import *
...
segmodel = SegFormer(in_channels=3,
                     ...
                     num_classes=20)
segmodel.load_state_dict(torch.load(f=f'../models/checkpoints/SegFormer/SegFormer-300-from-600.pth'))
segmodel.to(device)
